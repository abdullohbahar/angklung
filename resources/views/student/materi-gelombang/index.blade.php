                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12 text-center">
                                            <h4>
                                                <b>Mari Kita Belajar Gelombang</b>
                                            </h4>
                                        </div>
        ...
        <script>
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = "/siswa/materi/gelombang/eksplorasi"
                }
            });
        </script>
    @endif

    @if (session()->has('eksperimen_notification'))
        <script>
            Swal.fire({
                text: "{{ session('eksperimen_notification') }}",
                icon: "success",
                showCancelButton: false,
                confirmButtonColor: "#3085d6",
                cancelButtonColor: "#d33",
                confirmButtonText: "Eksperimen",
                allowOutsideClick: false
            }).then((result) => {
                if (result.isConfirmed) {
                    window.location.href = "/siswa/materi/gelombang/eksperimen"
                }
            });
        </script>
    @endif
