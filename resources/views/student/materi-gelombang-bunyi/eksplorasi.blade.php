                        ...
                        <div class="col-12">
                            <div class="card card-border" style="width: 100%">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12">
                                            <div id="liveworksheet7554314" style="width:100%">
                                                <span id="lwslink7554314"><a
                                                        href="https://www.liveworksheets.com/w/id/ilmu-pengetahuan-alam-ipa/7554314">Angklung</a>,
                                                    an interactive worksheet by <a
                                    ...
                                    <form action="{{ route('materi.gelombang.bunyi.store.eksplorasi') }}" method="POST">
                                        @csrf
                                        <div class="row">
...
@push('addons-js')
    ...
    <script>
        loadliveworksheet(7554314, 'rrgy', 11500, 'www', 'new');
    </script>
@endpush
