                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div id="liveworksheet7536964" style="width:100%">
                                                <span id="lwslink7536964"><a
                                                        href="https://www.liveworksheets.com/w/id/ilmu-pengetahuan-alam-ipa/7536964">Refleksi
                                                        01</a>, an interactive worksheet by <a
                                            ...
                                            <script>
                                                loadliveworksheet(7536964, 'axur', 2220, 'www', 'new');
                                            </script>
                                        </div>
                                    </div>
                                    <form action="{{ route('materi.getaran.refleksi.store') }}" method="POST">
                                        @csrf
                                        <div class="row">
