                        ...
                        <div class="col-12">
                            <div class="card card-border" style="width: 100%">
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('materi.getaran.store.orientasi') }}" method="POST">
                                        @csrf
                                        <input type="hidden" name="materi" value="getaran" id="">
                                        <div class="row">
                                            <div class="col-12 mt-3">
                                                1. Pernahkah kalian melihat atau merasakan secara langsung peristiwa
                                                tersebut?
                                            </div>
                                            <div class="col-12 mt-3">
                                        ...
                                        <div class="row">
                                            <div class="col-12 mt-3">
                                                2. Apa yang menyebabkan senar berbunyi?
                                            </div>
                                            <div class="col-12 mt-3">
